    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-emerald-100 relative overflow-hidden">
      ...
      <Card className="relative w-full max-w-md mx-4 shadow-2xl border border-emerald-100/50 bg-white/80 backdrop-blur-sm animate-slide-up">
        ...
        <CardHeader className="text-center pb-2 pt-6">
          <CardTitle className="text-3xl font-display font-bold text-emerald-900 tracking-wide">
            برنامج تعليم القرآن الكريم وتجويده
          </CardTitle>
          <p className="text-sm text-emerald-700/70 font-body mt-1 font-medium">نظام التعلم الإلكتروني</p>
        </CardHeader>
        
        <CardContent className="px-10 pb-10">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label htmlFor="username" className="block text-sm font-body font-medium text-emerald-900">
                Registration Number
              </label>
              <Input
                id="username"
                ...
                className="font-body h-12 bg-emerald-50/50 border-emerald-200 text-emerald-900 placeholder:text-emerald-400/70 focus:border-emerald-500 focus:ring-emerald-500 focus:bg-white transition-all duration-300"
                required
              />
            </div>
            
            <div className="space-y-2">
              <label htmlFor="password" className="block text-sm font-body font-medium text-emerald-900">
                Password
              </label>
              <Input
                id="password"
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="relative w-full font-body font-semibold h-12 bg-gradient-to-r from-emerald-700 via-emerald-600 to-emerald-700 hover:from-emerald-800 hover:via-emerald-700 hover:to-emerald-800 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-0.5 active:translate-y-0"
            >
              {isLoading ? (
          ...
          <div className="mt-8 pt-6 border-t border-emerald-100">
            <p className="text-center text-sm text-emerald-800/70 font-body">
              New here?{" "}
              <Link to="/register" className="font-semibold text-emerald-700 hover:text-emerald-900 transition-colors duration-200 underline decoration-emerald-300 underline-offset-4">
                Register
              </Link>
            </p>
          </div>
