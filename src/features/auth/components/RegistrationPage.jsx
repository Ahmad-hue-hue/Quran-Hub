      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-100 relative overflow-hidden">
        ...
        <Card className="relative w-full max-w-md mx-4 shadow-2xl border border-gray-200 bg-white/80 backdrop-blur-sm animate-slide-up">
          ...
          <CardContent className="px-10 pb-8 text-center space-y-6">
            ...
            <Button 
              onClick={handleLogin}
              className="w-full bg-primary hover:bg-gray-800 text-white py-3 font-display font-semibold"
            >
              Login
            </Button>
          </CardContent>
        ...
        <CardContent className="px-8 pb-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button 
              type="submit" 
              disabled={isLoading}
              className="w-full bg-primary hover:bg-gray-800 text-white py-3 font-display font-semibold disabled:opacity-50"
            >
